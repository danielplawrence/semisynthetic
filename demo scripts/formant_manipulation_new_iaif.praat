...
demo Paint rectangle: "grey", 0, 100, 0, 100
demo Black
demo Text: 50, "centre", 100, "top", "Speech Manipulator"
endif
#######################################################################
call selectSounds
...
if demo_mode=1
	call drawSound 'source_segment$' 0 0 10 25 70 90
	call drawSpec 'source_segment$' 0 0 10 25 40 60
	call drawSound 'target_segment$' 0 0 35 50 70 90
	call drawSpec 'target_segment$' 0 0 35 50 40 60
	call drawSound 'preceding_segment$' 0 0 60 75 70 90
	call drawSpec 'preceding_segment$' 0 0 60 75 40 60	
	call drawSound 'following_segment$' 0 0 70 85 70 90
	call drawSpec 'following_segment$' 0 0 70 85 40 60	
endif
